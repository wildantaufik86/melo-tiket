        ...
        <>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-blue-600">
                    {summary.users.male.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Perempuan</span>
                  <span className="font-semibold text-pink-600">
                    {summary.users.female.toLocaleString()}
                  </span>
                </div>
              </div>
              ...
              <div className="mt-4">
                <div className="flex rounded-full overflow-hidden h-3 bg-gray-200">
                  <div
                    ...
                    style={{
                      width: `${
                        (summary.users.male / summary.users.total) * 100
                      }%`,
                    }}
                  ></div>
                  <div
                    ...
                    style={{
                      width: `${
                        (summary.users.female / summary.users.total) * 100
                      }%`,
                    }}
                  ></div>
                </div>
                <div className="flex justify-between text-sm text-gray-500 mt-1">
                  <span>
                    {((summary.users.male / summary.users.total) * 100).toFixed(
                      1
                    )}
                    % Male
                  </span>
                  <span>
                    {(
                      (summary.users.female / summary.users.total) *
                      100
                    ).toFixed(1)}
                    % Female
                  </span>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-red-600">
                    {summary.transactions.rejected}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-500">Expired</span>
                  <span className="font-semibold text-gray-500">
                    {summary.transactions.expired}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <>
                  ...
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="font-bold text-blue-600">
                      {summary.tickets.totalStock.toLocaleString()}
                    </span>
                  </div>
                </>
              </div>
                ...
                <>
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-green-600">
                        {summary.tickets.totalSold.toLocaleString()}
                      </span>
                    </div>
                    <div className="text-sm text-gray-500 mt-1">
                      Revenue: Rp{' '}
                      {summary.tickets.totalSoldRevenue.toLocaleString()}
                    </div>
                  </div>
                </>
              </div>
                ...
                <>
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-orange-600">
                        Rp{' '}
                        {summary.transactions.totalTransactionAmount.toLocaleString()}
                      </span>
                    </div>
                    <div className="text-sm text-gray-500 mt-1">
                      {summary.transactions.totalCategoryTransactions} ticket
                      transaction
                    </div>
                  </div>
                </>
          ...
          <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-6 rounded-xl shadow-lg">
            <h2 className="text-xl font-semibold mb-4">
              Expected Total Revenue Summary
            </h2>
            <p className="text-3xl font-bold">
