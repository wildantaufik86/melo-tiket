                  ...
                  <tr key={event._id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-3 px-6 text-center rounded-br-2xl">
                      <div className="flex item-center justify-center space-x-2">
                        <Link href={`/admin/event-management/event/${event._id}/tickets`} target="_blank" className="p-2 bg-gray-500 text-white rounded-md hover:bg-gray-600" title="View Public Page">
                          <EyeIcon size={16} />
                        </Link>
                      </div>
                    </td>
