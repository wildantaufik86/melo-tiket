...
export const registerSchema = Joi.object({
  ...
  idNumber: Joi.string().length(16).required().messages({
    'string.length': 'nomor id harus 16 karakter',
    'any.required': 'nomor id perlu di inputkan',
    'string.empty': 'nomor id tidak boleh kosong',
  }),
  profile: Joi.object({
    ...
    dateOfBirth: Joi.string().required().messages({
      ...
      'any.required': 'tanggal lahir perlu di inputkan',
    }),
