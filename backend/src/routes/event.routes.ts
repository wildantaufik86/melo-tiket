...
eventRoutes.post("/create", authenticate, validateRole("superadmin"), createEventHandler);
eventRoutes.patch("/:eventId", authenticate, validateRole("superadmin"), updateEventHandler);
